...
About
Space Adventure is an arcade style game where you dodge falling asteroids using the left and right arrow keys. You can collect hearts and fuel on your journey to outer space, but be careful, if your fuel gauge depletes your ship will explode and it’s game over! Another way to lose the game is to run out of hearts on the way up. You lose hearts by asteroids hitting your ship.

Running the game
The main file to run the game is located in mainMenuView.java which is located in the SRC folder. Run the mainMenuView.java file through an IDE like intelliJ.
